function buildTimeline() {
  ...
  var debrief = {
    ...
    stimulus: function () {
      ...
      const msg = "<p>You responded correctly on <strong>" + accuracy + "%</strong> of the trials.</p><p>Your average response time was <strong>" + rt + "ms</strong>.</p><p>Press the button below complete the experiment. Thank you!</p>";
      return msg;
    },
    choices: ['Finish']
  };

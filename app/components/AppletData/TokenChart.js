...
class TokenChart extends React.Component {
  ...
  render() {
    ...
    let normalisedx = x(data[0].name) - GRAPH_BAR_WIDTH / 3 + 15
    let normalisedy = y(topValue + yValue + (data[0].value < 0 ? -0.01 * tickSize : 0.01 * tickSize),) * -1

...
import {
  downloadResponses,
  downloadAppletResponses,
} from "../responses/responses.thunks";
import {
  downloadAppletsMedia,
  downloadAppletMedia,
} from "../media/media.thunks";
...
export const downloadApplets = (onAppletsDownloaded = null) => (
  dispatch,
  getState
) => {
  const state = getState();

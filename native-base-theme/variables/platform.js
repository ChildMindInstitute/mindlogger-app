...
export default {
  ...
  badgePadding: (platform === 'ios') ? 3 : 0,
    ...
    // Button
  btnFontFamily: (platform === 'ios') ? 'Avenir' : 'Roboto_medium',
  ...
  brandSidebar: '#252932',
    ...
    // Font
  fontFamily: (platform === 'ios') ? 'Avenir' : 'Roboto',
  fontSizeBase: 18,
  ...
  toolbarHeight: (platform === 'ios') ? 88 : 56,
  ...
  noteFontSize: 14,
    ...
    // Title
  titleFontfamily: (platform === 'ios') ? 'Avenir' : 'Roboto_medium',
